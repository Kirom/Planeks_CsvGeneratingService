...
class DataSchema(models.Model):
    ...
    string_character = models.CharField(max_length=100,
                                        choices=[('"', 'Double qoute (")'), ("'", "Single quote (')")],
...
class Column(models.Model):
    ...
    name = models.CharField(max_length=100, verbose_name='Name')
    data_schema = models.ForeignKey(DataSchema, related_name='has_columns', on_delete=models.CASCADE)
...
class DataSet(models.Model):
    ...
    data_schema = models.ForeignKey(DataSchema, related_name='has_data_sets', on_delete=models.CASCADE)
